 ...
 * and outputs a list view of user return requests and allows the librarian to accept those requests.
...
public class ReceiveReturnsController implements Initializable{
	...
	/**
	 * Fills the list view with the list of users returning their items.
	...
	@FXML
	/**
	 * Takes borrowed item from the user.
	...
	public void handleReturns(ActionEvent event) throws IOException{
		...
		for (Copy item : Library.returningCopies) {
			if (item.getBook() != null) {
	...
	@Override
	/**
	 * Method that is immediately run when the scene is loaded and outputs data of list of users return requests.
	...
	public void initialize(URL url, ResourceBundle resources) {
		...
		fillLists(Library.returningCopies, Library.returningItems, userCopies);
