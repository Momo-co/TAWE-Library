 ...
 * Displays a list view of copies the user loaned and shows data for a chosen copy.
...
public class LoanController implements Initializable {
	...
	/**
	 * Fills the list view with the list of the user's borrowed items.
	...
	@FXML
	/**
	 * Displays the due date and fine of the selected copy.
	...
	@Override
	/**
	 * Method that is immediately run when the scene is loaded to output the list of borrowed items.
