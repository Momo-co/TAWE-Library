...
public class CollectItemsController implements Initializable{
	...
	ObservableList<String> items = FXCollections.observableArrayList("Book","Laptop");
	...
	@FXML
	public void handleCollect(ActionEvent event) throws IOException{
		Alert alert = new Alert(AlertType.INFORMATION);
		alert.setTitle("Success");
		alert.setHeaderText(null);
		alert.setContentText("Items Collected");
		alert.showAndWait();
	}
	@FXML
