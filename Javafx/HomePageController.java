...
public class HomePageController implements Initializable{
	...
	ObservableList<String> reserved = FXCollections.observableArrayList("Laptop");
	ObservableList<String> transactions = FXCollections.observableArrayList("Paid £10 fine","Add £100 to balance");
	
	public double b = 100.0;
	public String bal = Double.toString(b);
	@FXML
