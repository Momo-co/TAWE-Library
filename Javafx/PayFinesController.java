...
public class PayFinesController implements Initializable{
	...
	public Label totalFines;
	public TextField payment;
	//TableView<String> would be TableView<(Class that contains itemName and fine of a copy [probably copy])>
    public TableView<String> tableView;
    //TableColumn<String,String> would be TableColumn<class name,String>
    public TableColumn<String, String> itemName;
    public TableColumn<String, String> fine;
