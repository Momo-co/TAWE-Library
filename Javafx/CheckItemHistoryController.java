...
public class CheckItemHistoryController implements Initializable{
	...
	public ListView<String> listOfCopies;
	public ListView<String> listOfHistory;
	public String selected;
	ObservableList<String> copies = FXCollections.observableArrayList("copy 1","copy 2");
	ObservableList<String> history = FXCollections.observableArrayList("Returned at this time","Borrowed at this time");
